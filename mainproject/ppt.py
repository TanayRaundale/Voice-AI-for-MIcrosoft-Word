...
def create_ppt_text(Input):
    ...
    ms = ""
    speak("I have started fetching the details for your presentation")
...
def create_ppt(text_file, design_number, ppt_name):
    ...
    speak("Presentation generated.Opening The Presentation")
    
    file_path = f"GeneratedPresentations/{ppt_name}.pptx"
    os.startfile(fr"C:\Users\Dell\Desktop\final year project\mainproject\GeneratedPresentations\{ppt_name}.pptx")
    return f"{file_path}"
...
def get_bot_response(msg):
    ...
    if last_char.isdigit():
       ...
       speak("I am using the default design for your presentation")
    ...
    with open(fr'Cache/{input_string}.txt', 'w', encoding='utf-8') as f:
        f.write(create_ppt_text(input_string))

    pptlink = create_ppt(fr'Cache/{input_string}.txt', number, input_string)
    return str(pptlink)
